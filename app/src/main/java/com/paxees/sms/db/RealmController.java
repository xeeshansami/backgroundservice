...
//import com.hbl.vlinkapp.network.models.response.base.LoginResponse;
//import com.hbl.hblaccountopeningapp.network.models.response.base.LoginResponseRM;
//import com.hbl.hblaccountopeningapp.network.models.response.base.SpecificSurveyDetailsResponse;
//import com.hbl.hblaccountopeningapp.network.models.response.base.UserdetailsRM;
//import com.hbl.vlinkapp.network.models.request.base.SubmitAttachmentSurveyRequest;
//import com.hbl.vlinkapp.network.models.response.base.SurveyDetails;
//import com.hbl.vlinkapp.network.models.response.base.SurveyDetailsResponse;
//import com.hbl.vlinkapp.realmDB.model.SpecificSurveyDetailsResponseRM;
//import com.hbl.vlinkapp.realmDB.model.SubmitAttachmentSurveyRequestDB;
//import com.hbl.vlinkapp.realmDB.model.SurveyDetailsRM;
//import com.hbl.vlinkapp.realmDB.model.SurveyDetailsResponseRM;
...
//    }
//
//    public void setLoginResponse(LoginResponse data, String userEmail, String userPwd) {
//        String json = new Gson().toJson(data);
//        Type listType = new TypeToken<LoginResponseRM>() {
//        }.getType();
//        LoginResponseRM dta = new Gson().fromJson(json, listType);
//        dta.getUserdetails().setUserEmail(userEmail);
//        dta.getUserdetails().setUserPwd(userPwd);
//        Realm realm = Realm.getDefaultInstance();
//        realm.beginTransaction();
...
//    }
//
//    public void setSurveyDetails(SpecificSurveyDetailsResponse data, String surveyID, String userEmail) {
//        String json = new Gson().toJson(data);
//        Type listType = new TypeToken<SpecificSurveyDetailsResponseRM>() {
//        }.getType();
//        SpecificSurveyDetailsResponseRM dta = new Gson().fromJson(json, listType);
//        dta.setSurveyID(surveyID);
//        dta.setUserEmail(userEmail);
//        Realm realm = Realm.getDefaultInstance();
//        realm.beginTransaction();
//        realm.insertOrUpdate(dta);
//        realm.commitTransaction();
...
//
//
//    public UserdetailsRM getLoginUser(String userEmail) {
//        Realm realm = Realm.getDefaultInstance();
//        UserdetailsRM userObj = realm.where(UserdetailsRM.class).equalTo("userEmail", userEmail, Case.SENSITIVE).findFirst();
//        if (userObj != null) {
//            return realm.copyFromRealm(userObj);
//        }
//        return null;
//    }
//
//    public SpecificSurveyDetailsResponseRM getSurveyDetails(String userEmail, String surveyID) {
//        Realm realm = Realm.getDefaultInstance();
//        SpecificSurveyDetailsResponseRM userObj = realm.where(SpecificSurveyDetailsResponseRM.class)
//                .equalTo("userEmail", userEmail, Case.SENSITIVE)
//                .equalTo("surveyID", surveyID, Case.SENSITIVE)
//                .findFirst();
//        if (userObj != null) {
//            return realm.copyFromRealm(userObj);
//        }
//        return new SpecificSurveyDetailsResponseRM();
//    }
//
//    public UserdetailsRM getLoginUser(String userEmail, String password) {
//        Realm realm = Realm.getDefaultInstance();
//        UserdetailsRM userObj = realm.where(UserdetailsRM.class).equalTo("userEmail", userEmail, Case.SENSITIVE)
//                .equalTo("userPwd", password, Case.SENSITIVE).findFirst();
//        if (userObj != null) {
//            return realm.copyFromRealm(userObj);
//        }
//        return new UserdetailsRM();
//    }
//
//    public void setSurveyList(ArrayList<SurveyDetails> data, String userEmail) {
//        String json = new Gson().toJson(data);
//        Type listType = new TypeToken<ArrayList<SurveyDetailsRM>>() {
//        }.getType();
//        Realm realm = Realm.getDefaultInstance();
//        realm.beginTransaction();
//        ArrayList<SurveyDetailsRM> dta = new Gson().fromJson(json, listType);
//        for (SurveyDetailsRM x : dta) {
//            x.setUserEmail(userEmail);
//        }
//        realm.insertOrUpdate(dta);
//        realm.commitTransaction();
//    }
//
//    public void setSurveyAttachments(SubmitAttachmentSurveyRequest data,
//                                     String userId,
//                                     int imageCount,
//                                     ArrayList<String> imagesPath,
//                                     int possessionType,
//                                     String AspectsVerified,
//                                     String physicalv,
//                                     String crossv,
//                                     String marketcheck,
//                                     String longitude,
//                                     String latitude,
//                                     String createdBy,
//                                     boolean isInternalServery) {
//        Type listType = new TypeToken<SubmitAttachmentSurveyRequestDB>() {
//        }.getType();
//        Type listType2 = new TypeToken<RealmList<String>>() {
//        }.getType();
//        SubmitAttachmentSurveyRequestDB dta = new Gson().fromJson(new Gson().toJson(data), listType);
//        RealmList<String> list = new Gson().fromJson(new Gson().toJson(imagesPath), listType2);
//        dta.setUserID(userId);
//        dta.setImageCount(imageCount);
//        dta.setImagesArray(list);
//        dta.setInternalSurvey(isInternalServery);
//        if(isInternalServery) {
//            dta.setPossessionType(possessionType);
//            dta.setAspectsVerified(AspectsVerified);
//            dta.setPhysicallyExisted(physicalv);
//            dta.setCrossVerified(crossv);
//            dta.setMarketCheck(marketcheck);
//            dta.setLatitude(longitude);
//            dta.setLongitude(latitude);
//            dta.setCreatedBy(createdBy);
//        }
//        Realm realm = Realm.getDefaultInstance();
//        realm.beginTransaction();
//        realm.insertOrUpdate(dta);
...
//    }
//
//    public void setSubmitSurveys(String userId, String surveyID, String remarks) {
//        SubmitAttachmentSurveyRequestDB userObj = realm.where(SubmitAttachmentSurveyRequestDB.class)
//                .equalTo("userID", userId, Case.SENSITIVE)
//                .equalTo("aesRefNo", surveyID, Case.SENSITIVE).findFirst();
//        if (userObj != null) {
//            Realm realm = Realm.getDefaultInstance();
//            realm.beginTransaction();
//            userObj.setRemarks(remarks);
//            realm.insertOrUpdate(userObj);
//            realm.commitTransaction();
//        }
//    }
//
//    public ArrayList<SubmitAttachmentSurveyRequestDB> getSurveyAttachments(String userID) {
//        Realm realm = Realm.getDefaultInstance();
//        List<SubmitAttachmentSurveyRequestDB> userObj = realm.copyFromRealm(realm.where(SubmitAttachmentSurveyRequestDB.class)
//                .equalTo("userID", userID, Case.SENSITIVE).findAll());
//        ArrayList<SubmitAttachmentSurveyRequestDB> listobj = new ArrayList<>(userObj.size());
//        listobj.addAll(userObj);
//        if (userObj.size() != 0) {
//            return listobj;
//        } else {
//            return new ArrayList<SubmitAttachmentSurveyRequestDB>();
//        }
//    }
//
//    public SubmitAttachmentSurveyRequest getSubmitSurveys(String userID, String surveyID) {
//        Realm realm = Realm.getDefaultInstance();
//        SubmitAttachmentSurveyRequestDB userObj = realm.copyFromRealm(realm.where(SubmitAttachmentSurveyRequestDB.class)
//                .equalTo("surveyId", surveyID, Case.SENSITIVE)
//                .equalTo("userID", userID, Case.SENSITIVE).findFirst());
//        String json = new Gson().toJson(userObj);
//        return new Gson().fromJson(json, SubmitAttachmentSurveyRequest.class);
//    }
//
//    public ArrayList<SurveyDetails> getSurveyList(String userEmail) {
//        Realm realm = Realm.getDefaultInstance();
//        List<SurveyDetailsRM> userObj = realm.copyFromRealm(realm.where(SurveyDetailsRM.class).equalTo("userEmail", userEmail, Case.SENSITIVE).findAll());
//        String json = new Gson().toJson(userObj);
//        Type listType = new TypeToken<ArrayList<SurveyDetails>>() {
//        }.getType();
//        return new Gson().fromJson(json, listType);
//    }
//
//    public void deleteSpecificFromSurveyList(String surveyId) {
//        Realm realm = Realm.getDefaultInstance();
//        SurveyDetailsRM object = realm.where(SurveyDetailsRM.class).equalTo("surveyId", surveyId, Case.SENSITIVE).findFirst();
//        if (object != null) {
//            realm.beginTransaction();
...
//    }
//
//    public void deleteOfflineSpecificSurvey(String aesRefNo) {
//        Realm realm = Realm.getDefaultInstance();
//        SubmitAttachmentSurveyRequestDB object = realm.where(SubmitAttachmentSurveyRequestDB.class).equalTo("aesRefNo", aesRefNo, Case.SENSITIVE).findFirst();
//        if (object != null) {
//            realm.beginTransaction();
//            object.deleteFromRealm();
//            realm.commitTransaction();
...
//
//
//    public void deleteAllSurveysFromSpecificUser(String userEmail) {
//        Realm realm = Realm.getDefaultInstance();
//        RealmResults<SurveyDetailsRM> object = realm.where(SurveyDetailsRM.class).equalTo("userEmail", userEmail, Case.SENSITIVE).findAll();
//        if (object != null) {
//            for (SurveyDetailsRM x : object) {
//                realm.beginTransaction();
//                x.deleteFromRealm();
//                realm.commitTransaction();
//                Log.i("DeleteSurvey","True");
//            }
//        }
//    }
//
